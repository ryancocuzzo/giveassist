...
import {pr, emailField, passwordField, confirmPasswordField, phoneField, nameField, extractPhoneNumber, formatPlan, validateMoney
    , TEST_emailField, TEST_passwordField, TEST_confirmPasswordField, 
    TEST_phoneField, TEST_nameField} from '../../../Views-Test-Files/Test-Data/Data.js';
import { signup } from '../../../Helper-Files/Temp-DB-Utils.js';
import Popup from 'react-popup';
import {planExists, lowestPlanCost} from '../../../Helper-Files/variables';
...
export default class SignUp extends React.Component {
    ...
    handle_signup = () => {
        ...
        signup(name, email, pass, phone, plan, token).then((user) => Popup.alert('Welcome!')).catch((err) => Popup.alert('Sorry, we could not create your account at this time!'));
    }
