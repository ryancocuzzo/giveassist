...
export class InputComponent extends Component {
  ...
  // alternate_p_styling = () => {
  //   if (this.state.p_style === 'input_label')
  //     this.setState({p_style: 'input_label r2b'});
  //   if (this.state.p_style === 'input_label r2b')
  //     this.setState({p_style: 'input_label b2r'});
  //   if (this.state.p_style === 'input_label b2r')
  //     this.setState({p_style: 'input_label r2b'});
  ...
  render() {
    ...
    let editable = (
      ...
      >
        <span className={p_style}>{this.props.title}</span>
    <div className="siblings" style={{display: editing}}>
          {pretext_present ? (
