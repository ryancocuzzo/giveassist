  ...
  return (
    <div>
      <div style={styles} className={view_h_centered ? cssstyles.grd : ''}>
        <div style={{ backgroundColor: styles.backgroundColor || 'var(--primary)', height: styles.height, width: '100%' }}>
        ...
        <div style={pinned} className={cssstyles.pinned}>
          <div
            ...
            style={{
              ...
              alignContent: vcentered ? 'center' : 'start',
              alignItems: vcentered ? 'center' : 'start',
